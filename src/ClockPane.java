...
setCurrentTime(); }
 ...
 public ClockPane(int hour,int minute, int second , boolean sec , boolean min , boolean heu) {
 this.hour = hour;
 this.minute = minute;
 this.second = second;
 secondHandVisible =sec ;
minuteHandVisible = min ; 
hourHandVisible = heu; 
 //setsecondHandVisible(visib) ; 
 }
 ...
 public void sethourHandVisible(boolean a) {
   hourHandVisible=a; }
 public void setminuteHandVisible(boolean b) {
   minuteHandVisible= b; }
 public void setsecondHandVisible(boolean c) {
    //secondHandVisible =c; 
    sLine.setVisible(c);
